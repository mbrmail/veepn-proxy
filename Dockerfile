...
WORKDIR /go/src/github.com/Mbrmail/veepn-proxy
COPY . .
...
COPY --from=build /go/src/github.com/Mbrmail/veepn-proxy/veepn-proxy /
...
USER 9999:9999
EXPOSE 18080/tcp
ENTRYPOINT ["/veepn-proxy", "-bind-address", "0.0.0.0:18080"]
